...
# A Keras callback to save an ML models (of our custom type) at intervals of epochs during training
class ModelCheckpointer(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        if epoch - self.last_checkpoint_epoch >= self.checkpoint_epoch_interval:
            ...
            logging.info('epoch = {}. Intermediate models saved to {}'.format(epoch, model_filepath))
