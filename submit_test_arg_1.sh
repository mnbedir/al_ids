...
#SBATCH -J agent1_task     # Gonderilen isin ismi
#SBATCH --dependency singleton
#SBATCH -o experiment1.out    	# Ciktinin yazilacagi dosya adi
...
cd /truba/home/$USER/agent1/al_ids
config_folder_path=$1
./run_experiments_1.sh run_test_fast.py $config_folder_path > run_experiments.log 2>&1
